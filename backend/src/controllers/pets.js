...
exports.create = async (req, res, next) => {
    const {
        ...
        location,
        email,
        ownerName, // Include ownerName if needed
        contactNumber // Include contactNumber if needed
    } = req.body;
    ...
    try {
        ...
        if (!petname || !pettype || !petbreed || !petage || !location || !ownerName || !contactNumber||!email) {
        ...
        const pet = new ProductModel({
            ...
            location,
            status: 'available',
            ownerName, // Include ownerName in the model
            contactNumber // Include contactNumber in the model
        });
